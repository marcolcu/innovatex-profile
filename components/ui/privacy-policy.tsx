  ...
  return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Your privacy is important to us. This privacy policy explains the types of personal information we collect,
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-lg text-gray-600">
            We take the security of your personal information seriously and implement appropriate security measures to
            protect your data.
          </p>
        </section>
