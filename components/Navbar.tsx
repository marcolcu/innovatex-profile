        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
            ...
            <div className="hidden lg:flex lg:flex-1 lg:justify-end">
              <a href="https://wa.me/6281586525868" className="text-sm/6 font-semibold text-gray-900">
            ...
            <DialogPanel
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div className="py-6">
                    <a
                        href="https://wa.me/6281586525868"
          ...
          <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div
                ...
                Offering the best prices for your needs.{' '}
            ...
            <div className="text-center">
              <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                Elevating your website with InnovateX expertise.
              </h1>
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <a href="#feature" className="text-sm/6 font-semibold text-gray-900">
