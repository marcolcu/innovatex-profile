export default function Navbar() {
  return (
    <>
      <nav className="w-full h-32 border-b-3 border-b-black/25 flex justify-between items-center px-32 text-3xl font-extralight font-telegraf fixed bg-white/0 z-[20] backdrop-blur-3xl top-0">
