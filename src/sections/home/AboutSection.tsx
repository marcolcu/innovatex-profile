...
export default function AboutSection() {
  return (
    <>
      <section className="w-full h-[700px] border-b-2 border-black/25 flex">
        <div className="flex-3 border-r-2 border-black/25 flex items-center justify-center">
          <p className="font-telegraf font-medium text-4xl w-[80%]">
        ...
        <div className="flex-2 flex items-center justify-center flex-col gap-20">
          <p className="font-extralight text-2xl w-[70%]">
