...
export default function AboutSection() {
  ...
  return (
    <>
      <section className="w-full h-[700px] border-b-2 border-black/25 flex flex-col xl:flex-row py-56 xl:py-0 relative">
        ...
        <div className="flex-2 flex items-center justify-center flex-col gap-20">
          <p className="font-extralight text-xl w-[80%] mt-5 xl:text-2xl xl:w-[70%] xl:mt-0">
          ...
          <button
            className="px-10 py-5 text-4xl font-telegraf font-extralight relative border-2 border-black/25 hover:bg-black hover:text-white transition-all duration-300"
